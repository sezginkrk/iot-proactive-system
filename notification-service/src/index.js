  ...
  try {
    await db.query(
      `UPDATE notification_settings SET
        ...
        low_battery_critical       = $7,
        low_battery_warning        = $8,
        high_temp_warning          = $9,
        high_temp_critical         = $10,
        low_clean_water_warning    = $11,
        low_clean_water_critical   = $12,
        high_grey_water_warning    = $13,
        high_grey_water_critical   = $14,
        updated_at                 = NOW()
       WHERE user_id = $1`,
      [
        userId,
